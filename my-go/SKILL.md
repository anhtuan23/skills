...
1. **Formatting**: Format every Go file in the relevant module with `golangci-lint fmt`. The workspace root `.golangci.yml` owns `gofumpt`, `goimports`, and 100-column `golines` formatting.
